...
public class BlockInit
{
    ...
    {
        Registry.register(Registry.ITEM, new Identifier(MiningDims.MOD_ID, "mining_portal_block"), new BlockItem(MINING_PORTAL_BLOCK, new Item.Settings().group(MiningDims.MINING_DIMS_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(MiningDims.MOD_ID, "hunting_portal_block"), new BlockItem(HUNTING_PORTAL_BLOCK, new Item.Settings().group(MiningDims.MINING_DIMS_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(MiningDims.MOD_ID, "caving_portal_block"), new BlockItem(CAVING_PORTAL_BLOCK, new Item.Settings().group(MiningDims.MINING_DIMS_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(MiningDims.MOD_ID, "nethering_portal_block"), new BlockItem(NETHERING_PORTAL_BLOCK, new Item.Settings().group(MiningDims.MINING_DIMS_GROUP)));
        Registry.register(Registry.ITEM, new Identifier(MiningDims.MOD_ID, "climbing_portal_block"), new BlockItem(CLIMBING_PORTAL_BLOCK, new Item.Settings().group(MiningDims.MINING_DIMS_GROUP)));
    }
}
